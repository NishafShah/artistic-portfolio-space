...
const Index = () => {
  ...
  useEffect(() => {
    ...
    // If there are no projects, use the default ones
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      {/* Hero Section */}
      <section id="home" className="min-h-screen flex flex-col items-center justify-center bg-gradient-to-br from-white to-purple-100 px-4 relative">
        <div className="absolute inset-0 bg-[url('https://images.unsplash.com/photo-1614851099175-e5b30eb6f696')] bg-cover bg-center opacity-10"></div>
        <div className="text-center relative z-10 max-w-3xl mx-auto">
          <p className="text-purple-600 font-medium mb-4 tracking-wider uppercase">Welcome to my portfolio</p>
      ...
      {/* Projects Section */}
      <section id="projects" className="py-24 px-4 bg-gradient-to-br from-gray-50 to-purple-50">
      ...
      {/* Contact Section */}
      <section id="contact" className="py-24 px-4 bg-gradient-to-br from-gray-50 to-purple-50">
